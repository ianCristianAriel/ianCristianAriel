...
<div style="display: flex; align-items: center;">
    <div style="flex: 2; margin-right: 20px; margin-left: 20px;"> <!-- Agregado el margen a la derecha -->
        <img align="center" width="1200" height="350" src="https://blogs.microsoft.com/wp-content/uploads/prod/sites/73/2020/07/open-data-map.gif" style="border-radius: 15px;">
    </div>
