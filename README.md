...
<!--
**ianCristianAriel/ianCristianAriel** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- 📖 Mis certificaciones y cursos:
    ...
    -Curso SQL (Completado). Contenido -> https://youtube.com/playlist?list=PLU8oAlHdN5Bmx-LChV4K3MbHrpZKefNwn
	  -Curso introductorio CSS (Completado) -> https://www.youtube.com/watch?v=wZniZEbPAzk
    -Curso introductorio HTML (Completado) -> https://www.youtube.com/watch?v=MJkdaVFHrto
